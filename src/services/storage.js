...
export const INITIAL_DATA = {
  ...
  clients: [
    { id: 'cli-1', name: 'Эрик', phone: '', car: 'Range Rover / Chery', initialBalance: 0, notes: '', createdAt: new Date().toISOString() },
    { id: 'cli-2', name: 'Александр', phone: '', car: 'Passat / Vito', initialBalance: 0, notes: '', createdAt: new Date().toISOString() },
  ],
  clientTransactions: [],
  suppliersList: ['Склад', 'Партс-Трейд', 'Автодок', 'Одесса', 'Тотус', 'Эрнест', 'Элит'],
  otherCounterparties: [
    { id: 'oth-1', name: 'Тотус', phone: '', notes: '', createdAt: new Date().toISOString() },
    { id: 'oth-2', name: 'Элит', phone: '', notes: '', createdAt: new Date().toISOString() },
    { id: 'oth-3', name: 'Партс-Трейд', phone: '', notes: '', createdAt: new Date().toISOString() },
    { id: 'oth-4', name: 'Автодок', phone: '', notes: '', createdAt: new Date().toISOString() },
  ],
  otherTransactions: [],
};
