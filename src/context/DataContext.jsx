...
function DataContextConsumer({ children, auth, ...dataProps }) {
  ...
  const mergedValue = {
    ...
    updateBackendUrl: sync.updateBackendUrl,
    backendHealth: sync.backendHealth,
    backendLoading: sync.backendLoading,
    checkBackend: sync.checkBackend,
    syncToPostgres: sync.syncToPostgres,
    pullFromPostgres: sync.pullFromPostgres,
