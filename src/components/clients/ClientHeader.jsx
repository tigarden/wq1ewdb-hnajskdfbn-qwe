...
export default function ClientHeader({
  ...
  return (
    <div className="surface-card rounded-xl border border-white/[0.08] p-4 sm:p-5 space-y-4 shadow-lg">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/[0.06] pb-3.5">
        <div className="space-y-1">
          <div className="flex items-center space-x-2.5">
            <h1 className="text-lg sm:text-xl font-bold text-white tracking-tight">{client.name}</h1>
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-300">
            {client.car && (
              <span className="flex items-center space-x-1.5 px-2 py-0.5 rounded-md bg-slate-900 border border-white/5">
                <Car className="w-3.5 h-3.5 text-blue-400" />
                <span className="font-medium text-slate-200">{client.car}</span>
              </span>
            )}
            {client.phone && (
              <span className="flex items-center space-x-1.5 px-2 py-0.5 rounded-md bg-slate-900 border border-white/5 font-mono text-[11px]">
            ...
            {client.notes && (
              <span className="flex items-center space-x-1 text-slate-400 italic text-[11px]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="btn-sm btn-primary font-bold shadow-xs shadow-blue-500/20"
          >
          ...
          <button
            ...
            className="btn-sm bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold shadow-xs shadow-emerald-500/20"
          >
          ...
          <button
            ...
            className="w-8 h-8 rounded-lg text-slate-400 hover:text-slate-200 bg-slate-950/80 hover:bg-slate-900 border border-white/10 flex items-center justify-center transition-colors"
          >
          ...
          <button
            ...
            className="w-8 h-8 rounded-lg text-rose-400 hover:text-rose-300 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/20 flex items-center justify-center transition-colors"
          >
