          ...
          <div className="flex items-center justify-between h-14 2xl:h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center">
                {syncStatus === 'syncing' ? (
                  <div className="h-9 px-2.5 sm:px-3 rounded-xl bg-amber-500/10 text-amber-300 border border-amber-500/25 text-xs font-medium inline-flex items-center space-x-1.5">
                  ...
                  <button
                    onClick={() => pushToGitHub()}
                    className="h-9 px-2.5 sm:px-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 font-bold text-xs inline-flex items-center space-x-1.5 shadow-sm shadow-amber-500/20 active:scale-95 transition-transform"
                  ...
                  <button 
                    ...
                    className="h-9 px-2.5 sm:px-3 rounded-xl bg-slate-950 text-slate-400 border border-white/10 text-xs font-medium hover:text-slate-200 transition-colors inline-flex items-center space-x-1.5 active:scale-95"
                    title="Оффлайн режим"
                  >
